...
def get_yolov5():
    # local best.pt
    model = torch.hub.load('/home/vietanh/Documents/VinXray/yolov5', 'custom', path='/home/vietanh/Documents/VinXray/yolov5/runs/train/exp/weights/best.pt', source='local')  # local repo
    model.conf = 0.4
    return model
